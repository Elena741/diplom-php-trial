...
<div class="container">
  ...
  <form class="form-horizontal" action="<?php echo e(route('admin.category.update', $category)); ?>" method="post">
    <input type="hidden" name="_method" value="put">
    <?php echo e(csrf_field()); ?>


    
    <?php echo $__env->make('admin.categories.partials.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
